	...
	extends FastScrollRecyclerView
{
	...
	public boolean requestFocus(int direction, Rect previouslyFocusedRect) {
		...
		return requestFocusForFlexibleAdapter(direction, previouslyFocusedRect);
	}

	private boolean requestFocusForFlexibleAdapter(int direction, Rect previouslyFocusedRect) {
