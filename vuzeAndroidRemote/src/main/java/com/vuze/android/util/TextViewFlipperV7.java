	...
	extends TextViewFlipper
{
  ...
  flipIt(tv, new AnimationAdapter() {
    ...
    public void onAnimationRepeat(Animation animation) {
      handleAnimationRepeat(tv, newText, validator);
    }
  });
  return true;
}

private void handleAnimationRepeat(TextView tv, CharSequence newText, FlipValidator validator) {
...
// flipIt method remains unchanged
