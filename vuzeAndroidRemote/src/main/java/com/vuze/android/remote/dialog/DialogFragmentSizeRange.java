	...
	extends DialogFragmentBase
{
    ...
    initialEndRounded = calculateInitialEndRounded(initialEnd);
  ...
  private long calculateInitialEndRounded(long initialEnd) {
  ...
  private void handleRangeChanged(String callbackID) {
    if (mListener != null) {
      mListener.onSizeRangeChanged(callbackID, start, end);
    }
  }

  private void handleRangeCleared(String callbackID) {
    if (mListener != null) {
      mListener.onSizeRangeChanged(callbackID, 0, -1);
    }
  }
