	...
	FlexibleRecyclerAdapter<SideActionsAdapter.SideActionsHolder, SideActionsAdapter.SideActionsInfo>
{
    ...
    setItems(getSideActionsInfo());
  }

  private List<SideActionsInfo> getSideActionsInfo() {
    List<SideActionsInfo> list = new ArrayList<>();
    if (restrictToMenuIDs == null) {
      list.addAll(getAllVisibleItems());
    } else {
      list.addAll(getRestrictedItems());
    }
    return list;
  }
  
  private List<SideActionsInfo> getAllVisibleItems() {
    List<SideActionsInfo> list = new ArrayList<>();
  ...
  private List<SideActionsInfo> getRestrictedItems() {
    List<SideActionsInfo> list = new ArrayList<>();
