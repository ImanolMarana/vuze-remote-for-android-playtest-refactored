	...
	SwipeRefreshLayoutExtra.OnExtraViewVisibilityChangeListener
{
	...
	private void setupSideListArea(View view) {
      ...
      private void setupSideListHelper(View view, boolean showActionsArea) {
      ...
      private void setupSideListComponents(View view, boolean showActionsArea) {
