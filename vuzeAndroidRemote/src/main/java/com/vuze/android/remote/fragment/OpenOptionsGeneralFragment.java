	...
	extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (ourActivity != null) {
			setupCheckListeners(btnPositionLast, btnStateQueued);
		}
		...
		handleTorrentData(session, torrent);

		setupButtonListeners(btnEditDir, btnEditName, session);

		return topView;
	}

	private void setupCheckListeners(CompoundButton btnPositionLast, CompoundButton btnStateQueued) {
	...
	private void handleTorrentData(Session session, final Map<?, ?> torrent) {
	...
	private void setupButtonListeners(ImageButton btnEditDir, ImageButton btnEditName, final Session session) {
		if (btnEditDir != null) {
