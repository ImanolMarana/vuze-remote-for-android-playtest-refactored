...
public class AndroidUtils
{
	...
	private static boolean isTV_API13() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
			...
			if (!tv) {
				...
				tv = context.getPackageManager().hasSystemFeature(
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB_MR2)
	private static boolean checkTVLibraries(Context context) {
