	...
	extends LetterFilter<String>
{
    ...
    private void filterByType(List<String> searchResultList) {
    ...
    private boolean shouldRemoveItem(Map<?, ?> map) {
        return !filterShowSearchTemplates && MapUtils.getMapBoolean(map,
                TransmissionVars.FIELD_SUBSCRIPTION_IS_SEARCH_TEMPLATE, false)
                || filterOnlyUnseen && MapUtils.getMapLong(map,
